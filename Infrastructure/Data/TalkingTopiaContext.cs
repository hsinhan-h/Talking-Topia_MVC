...
public partial class TalkingTopiaContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Name=ConnectionStrings:TalkingTopiaDb");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        #region init modelBuilder
    ...
    new Nation { NationId = 1, NationName = "臺灣", FlagImage = "~/image/flag_imgs/taiwan_flag.jpg" },
    new Nation { NationId = 2, NationName = "日本", FlagImage = "~/image/flag_imgs/japan_flag.png" },
    new Nation { NationId = 3, NationName = "英國", FlagImage = "~/image/flag_imgs/uk_flag.png" },
    new Nation { NationId = 4, NationName = "美國", FlagImage = "~/image/flag_imgs/us_flag.png" },
    new Nation { NationId = 5, NationName = "法國", FlagImage = "~/image/flag_imgs/france_flag.png" },
    new Nation { NationId = 6, NationName = "德國", FlagImage = "~/image/flag_imgs/germany_flag.webp" },
    new Nation { NationId = 7, NationName = "西班牙", FlagImage = "~/image/flag_imgs/spain_flag.png" },
    new Nation { NationId = 8, NationName = "印度", FlagImage = "~/image/flag_imgs/india_flag.png" },
    new Nation { NationId = 9, NationName = "墨西哥", FlagImage = "~/image/flag_imgs/mexico_flag.webp" },
    new Nation { NationId = 10, NationName = "其他", FlagImage = "~/image/flag_imgs/other_flag.png" }
);
    ...
    new Member { MemberId = 31, HeadShotImage = "https://randomuser.me/api/portraits/men/31.jpg", NationId = 1, IsVerifiedTutor = true, FirstName = "Henry", LastName = "Evans", Password = "password31", Email = "henry.evans@example.com", Nickname = "HenryE", Phone = "111222333", Birthday = DateTime.Now.AddYears(-30), Gender = 1, NativeLanguage = "English", SpokenLanguage = "English, Spanish", BankCode = "031", BankAccount = "1234567890", EducationId = 1, TutorIntro = "Expert in English and Spanish", Account = "henry_evans", AccountType = 1, Cdate = DateTime.Now, Udate = DateTime.Now, IsTutor = true },
new Member { MemberId = 32, HeadShotImage = "https://randomuser.me/api/portraits/women/32.jpg", NationId = 2, IsVerifiedTutor = false, FirstName = "Chloe", LastName = "Scott", Password = "password32", Email = "chloe.scott@example.com", Nickname = "ChloeS", Phone = "444555666", Birthday = DateTime.Now.AddYears(-24), Gender = 2, NativeLanguage = "Japanese", SpokenLanguage = "Japanese, English", BankCode = "032", BankAccount = "2345678901", EducationId = 2, TutorIntro = "Japanese language expert", Account = "chloe_scott", AccountType = 2, Cdate = DateTime.Now, Udate = DateTime.Now, IsTutor = true },
new Member { MemberId = 33, HeadShotImage = "https://randomuser.me/api/portraits/men/33.jpg", NationId = 3, IsVerifiedTutor = true, FirstName = "Jackson", LastName = "Mitchell", Password = "password33", Email = "jackson.mitchell@example.com", Nickname = "JackM", Phone = "555666777", Birthday = DateTime.Now.AddYears(-29), Gender = 1, NativeLanguage = "Korean", SpokenLanguage = "Korean, English", BankCode = "033", BankAccount = "3456789012", EducationId = 3, TutorIntro = "Korean language expert", Account = "jackson_mitchell", AccountType = 1, Cdate = DateTime.Now, Udate = DateTime.Now, IsTutor = true },
new Member { MemberId = 34, HeadShotImage = "https://randomuser.me/api/portraits/women/34.jpg", NationId = 4, IsVerifiedTutor = false, FirstName = "Amelia", LastName = "Martinez", Password = "password34", Email = "amelia.martinez@example.com", Nickname = "AmeliaM", Phone = "666777888", Birthday = DateTime.Now.AddYears(-25), Gender = 2, NativeLanguage = "German", SpokenLanguage = "German, English", BankCode = "034", BankAccount = "4567890123", EducationId = 4, TutorIntro = "Expert in German language", Account = "amelia_martinez", AccountType = 2, Cdate = DateTime.Now, Udate = DateTime.Now, IsTutor = true },
new Member { MemberId = 35, HeadShotImage = "https://randomuser.me/api/portraits/men/35.jpg", NationId = 5, IsVerifiedTutor = true, FirstName = "Sebastian", LastName = "Morris", Password = "password35", Email = "sebastian.morris@example.com", Nickname = "SebM", Phone = "777888999", Birthday = DateTime.Now.AddYears(-26), Gender = 1, NativeLanguage = "French", SpokenLanguage = "French, English", BankCode = "035", BankAccount = "5678901234", EducationId = 5, TutorIntro = "French language specialist", Account = "sebastian_morris", AccountType = 1, Cdate = DateTime.Now, Udate = DateTime.Now, IsTutor = true },
new Member { MemberId = 36, HeadShotImage = "https://randomuser.me/api/portraits/women/36.jpg", NationId = 6, IsVerifiedTutor = false, FirstName = "Grace", LastName = "Cooper", Password = "password36", Email = "grace.cooper@example.com", Nickname = "GraceC", Phone = "888999000", Birthday = DateTime.Now.AddYears(-23), Gender = 2, NativeLanguage = "Spanish", SpokenLanguage = "Spanish, English", BankCode = "036", BankAccount = "6789012345", EducationId = 6, TutorIntro = "Spanish language expert", Account = "grace_cooper", AccountType = 2, Cdate = DateTime.Now, Udate = DateTime.Now, IsTutor = true },
new Member { MemberId = 37, HeadShotImage = "https://randomuser.me/api/portraits/men/37.jpg", NationId = 7, IsVerifiedTutor = true, FirstName = "Aiden", LastName = "Perez", Password = "password37", Email = "aiden.perez@example.com", Nickname = "AidenP", Phone = "999000111", Birthday = DateTime.Now.AddYears(-31), Gender = 1, NativeLanguage = "Chinese", SpokenLanguage = "Chinese, English", BankCode = "037", BankAccount = "7890123456", EducationId = 7, TutorIntro = "Chinese language expert", Account = "aiden_perez", AccountType = 1, Cdate = DateTime.Now, Udate = DateTime.Now, IsTutor = true },
new Member { MemberId = 38, HeadShotImage = "https://randomuser.me/api/portraits/women/38.jpg", NationId = 8, IsVerifiedTutor = false, FirstName = "Avery", LastName = "Nelson", Password = "password38", Email = "avery.nelson@example.com", Nickname = "AveryN", Phone = "000111222", Birthday = DateTime.Now.AddYears(-22), Gender = 2, NativeLanguage = "Russian", SpokenLanguage = "Russian, English", BankCode = "038", BankAccount = "8901234567", EducationId = 8, TutorIntro = "Russian language expert", Account = "avery_nelson", AccountType = 2, Cdate = DateTime.Now, Udate = DateTime.Now, IsTutor = true },
new Member { MemberId = 39, HeadShotImage = "https://randomuser.me/api/portraits/men/39.jpg", NationId = 9, IsVerifiedTutor = true, FirstName = "Oliver", LastName = "King", Password = "password39", Email = "oliver.king@example.com", Nickname = "OliverK", Phone = "111222333", Birthday = DateTime.Now.AddYears(-34), Gender = 1, NativeLanguage = "Italian", SpokenLanguage = "Italian, English", BankCode = "039", BankAccount = "0123456789", EducationId = 9, TutorIntro = "Italian language expert", Account = "oliver_king", AccountType = 1, Cdate = DateTime.Now, Udate = DateTime.Now, IsTutor = true },
new Member { MemberId = 40, HeadShotImage = "https://Infrastructure.Data.TalkingTopiaContextrandomuser.me/api/portraits/women/40.jpg", NationId = 10, IsVerifiedTutor = false, FirstName = "Ella", LastName = "Wood", Password = "password40", Email = "ella.wood@example.com", Nickname = "EllaW", Phone = "222333444", Birthday = DateTime.Now.AddYears(-28), Gender = 2, NativeLanguage = "Portuguese", SpokenLanguage = "Portuguese, English", BankCode = "040", BankAccount = "2345678901", EducationId = 10, TutorIntro = "Portuguese language expert", Account = "ella_wood", AccountType = 2, Cdate = DateTime.Now, Udate = DateTime.Now, IsTutor = true }



);
        modelBuilder.Entity<Course>().HasData(
 new Course { CourseId = 1, CategoryId = 1, SubjectId = 1, TutorId = 1, Title = "基礎英文", SubTitle = "從零開始學英文", TwentyFiveMinUnitPrice = 350m, FiftyMinUnitPrice = 595m, Description = "適合初學者的英文課程", IsEnabled = true, ThumbnailUrl = "/image/thumb_nails/thumbnail_demo_tw_001.webp", VideoUrl = "https://www.youtube.com/embed/1ZYbU82GVz4", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 2, CategoryId = 1, SubjectId = 2, TutorId = 2, Title = "日語入門", SubTitle = "日語學習的基礎", TwentyFiveMinUnitPrice = 400m, FiftyMinUnitPrice = 680m, Description = "基礎日語語法和詞彙", IsEnabled = true, ThumbnailUrl = "/image/thumb_nails/thumbnail_demo_jp_001.webp", VideoUrl = "https://www.youtube.com/embed/BWAK0J8Uhzk", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 3, CategoryId = 1, SubjectId = 3, TutorId = 3, Title = "中文語法", SubTitle = "掌握中文語法", TwentyFiveMinUnitPrice = 500m, FiftyMinUnitPrice = 875m, Description = "全面學習中文語法", IsEnabled = true, ThumbnailUrl = "https://example.com/courses/chinese.jpg", VideoUrl = "https://example.com/courses/chinese_intro.mp4", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 4, CategoryId = 1, SubjectId = 4, TutorId = 4, Title = "德語會話", SubTitle = "學習德語會話技巧", TwentyFiveMinUnitPrice = 550m, FiftyMinUnitPrice = 935m, Description = "提高德語口語能力", IsEnabled = true, ThumbnailUrl = "https://example.com/courses/german.jpg", VideoUrl = "https://example.com/courses/german_intro.mp4", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 5, CategoryId = 1, SubjectId = 5, TutorId = 5, Title = "法語閱讀", SubTitle = "學習法語閱讀理解", TwentyFiveMinUnitPrice = 300m, FiftyMinUnitPrice = 510m, Description = "提升法語閱讀能力", IsEnabled = true, ThumbnailUrl = "https://example.com/courses/french.jpg", VideoUrl = "https://example.com/courses/french_intro.mp4", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 6, CategoryId = 1, SubjectId = 6, TutorId = 6, Title = "西班牙語寫作", SubTitle = "掌握西班牙語寫作技巧", TwentyFiveMinUnitPrice = 800m, FiftyMinUnitPrice = 1440m, Description = "提高西班牙語寫作能力", IsEnabled = true, ThumbnailUrl = "https://example.com/courses/spanish.jpg", VideoUrl = "https://example.com/courses/spanish_intro.mp4", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 7, CategoryId = 2, SubjectId = 7, TutorId = 7, Title = "HTML/CSS 基礎", SubTitle = "學習網頁開發基礎", TwentyFiveMinUnitPrice = 450m, FiftyMinUnitPrice = 765m, Description = "從頭開始學習HTML和CSS", IsEnabled = true, ThumbnailUrl = "https://example.com/courses/html_css.jpg", VideoUrl = "https://example.com/courses/html_css_intro.mp4", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 8, CategoryId = 2, SubjectId = 8, TutorId = 8, Title = "JavaScript 編程", SubTitle = "JavaScript 編程基礎", TwentyFiveMinUnitPrice = 600m, FiftyMinUnitPrice = 1050m, Description = "學習JavaScript語法和應用", IsEnabled = true, ThumbnailUrl = "https://example.com/courses/javascript.jpg", VideoUrl = "https://example.com/courses/javascript_intro.mp4", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 9, CategoryId = 2, SubjectId = 9, TutorId = 9, Title = "C# 進階", SubTitle = "掌握C#的進階技巧", TwentyFiveMinUnitPrice = 900m, FiftyMinUnitPrice = 1620m, Description = "深入學習C#編程", IsEnabled = true, ThumbnailUrl = "https://example.com/courses/csharp.jpg", VideoUrl = "https://example.com/courses/csharp_intro.mp4", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 10, CategoryId = 2, SubjectId = 10, TutorId = 10, Title = "SQL 資料庫", SubTitle = "學習SQL語法和資料庫操作", TwentyFiveMinUnitPrice = 350m, FiftyMinUnitPrice = 595m, Description = "從零開始學習SQL", IsEnabled = true, ThumbnailUrl = "https://example.com/courses/sql.jpg", VideoUrl = "https://example.com/courses/sql_intro.mp4", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 11, CategoryId = 2, SubjectId = 11, TutorId = 11, Title = "Python 入門", SubTitle = "掌握Python的基礎知識", TwentyFiveMinUnitPrice = 550m, FiftyMinUnitPrice = 935m, Description = "從頭開始學習Python編程", IsEnabled = true, ThumbnailUrl = "https://example.com/courses/python.jpg", VideoUrl = "https://example.com/courses/python_intro.mp4", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 12, CategoryId = 2, SubjectId = 12, TutorId = 12, Title = "Java 基礎", SubTitle = "Java編程的入門課程", TwentyFiveMinUnitPrice = 600m, FiftyMinUnitPrice = 1080m, Description = "從零開始學習Java語言", IsEnabled = true, ThumbnailUrl = "https://example.com/courses/java.jpg", VideoUrl = "https://example.com/courses/java_intro.mp4", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 13, CategoryId = 3, SubjectId = 13, TutorId = 13, Title = "數學基礎", SubTitle = "學習數學的基本概念", TwentyFiveMinUnitPrice = 300m, FiftyMinUnitPrice = 540m, Description = "提升數學基礎知識", IsEnabled = true, ThumbnailUrl = "https://example.com/courses/math.jpg", VideoUrl = "https://example.com/courses/math_intro.mp4", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 14, CategoryId = 3, SubjectId = 14, TutorId = 14, Title = "物理入門", SubTitle = "學習物理的基本理論", TwentyFiveMinUnitPrice = 350m, FiftyMinUnitPrice = 630m, Description = "物理學基礎知識", IsEnabled = true, ThumbnailUrl = "https://example.com/courses/physics.jpg", VideoUrl = "https://example.com/courses/physics_intro.mp4", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 15, CategoryId = 3, SubjectId = 15, TutorId = 15, Title = "化學基礎", SubTitle = "學習化學的基本概念", TwentyFiveMinUnitPrice = 400m, FiftyMinUnitPrice = 680m, Description = "全面了解化學基礎知識", IsEnabled = true, ThumbnailUrl = "https://example.com/courses/chemistry.jpg", VideoUrl = "https://example.com/courses/chemistry_intro.mp4", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 16, CategoryId = 3, SubjectId = 16, TutorId = 16, Title = "歷史研究", SubTitle = "深入了解歷史事件", TwentyFiveMinUnitPrice = 600m, FiftyMinUnitPrice = 1050m, Description = "歷史事件和背景的深入分析", IsEnabled = true, ThumbnailUrl = "https://example.com/courses/history.jpg", VideoUrl = "https://example.com/courses/history_intro.mp4", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 17, CategoryId = 3, SubjectId = 17, TutorId = 17, Title = "地理概論", SubTitle = "學習地理的基本知識", TwentyFiveMinUnitPrice = 500m, FiftyMinUnitPrice = 875m, Description = "全面了解地理學的基礎", IsEnabled = true, ThumbnailUrl = "https://example.com/courses/geography.jpg", VideoUrl = "https://example.com/courses/geography_intro.mp4", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 18, CategoryId = 3, SubjectId = 18, TutorId = 18, Title = "生物學基礎", SubTitle = "深入理解生物學", TwentyFiveMinUnitPrice = 750m, FiftyMinUnitPrice = 1350m, Description = "深入學習生物學的基本概念", IsEnabled = true, ThumbnailUrl = "https://example.com/courses/biology.jpg", VideoUrl = "https://example.com/courses/biology_intro.mp4", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 19, CategoryId = 1, SubjectId = 1, TutorId = 19, Title = "高級英文", SubTitle = "提升英語會話能力", TwentyFiveMinUnitPrice = 650m, FiftyMinUnitPrice = 1135m, Description = "深入練習英語會話和詞彙", IsEnabled = true, ThumbnailUrl = "https://example.com/courses/advanced_english.jpg", VideoUrl = "https://example.com/courses/advanced_english_intro.mp4", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 20, CategoryId = 1, SubjectId = 2, TutorId = 20, Title = "進階日語", SubTitle = "提升日語語法和會話技巧", TwentyFiveMinUnitPrice = 700m, FiftyMinUnitPrice = 1225m, Description = "提升日語會話和語法能力", IsEnabled = true, ThumbnailUrl = "https://example.com/courses/advanced_japanese.jpg", VideoUrl = "https://example.com/courses/advanced_japanese_intro.mp4", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 21, CategoryId = 1, SubjectId = 3, TutorId = 21, Title = "高級中文", SubTitle = "提升中文語法和詞彙", TwentyFiveMinUnitPrice = 850m, FiftyMinUnitPrice = 1480m, Description = "深入學習中文語法和詞彙", IsEnabled = true, ThumbnailUrl = "https://example.com/courses/advanced_chinese.jpg", VideoUrl = "https://example.com/courses/advanced_chinese_intro.mp4", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 22, CategoryId = 1, SubjectId = 4, TutorId = 22, Title = "高級德語", SubTitle = "提升德語會話技巧", TwentyFiveMinUnitPrice = 550m, FiftyMinUnitPrice = 990m, Description = "德語會話和詞彙的深入練習", IsEnabled = true, ThumbnailUrl = "https://example.com/courses/advanced_german.jpg", VideoUrl = "https://example.com/courses/advanced_german_intro.mp4", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 23, CategoryId = 1, SubjectId = 5, TutorId = 23, Title = "高級法語", SubTitle = "提升法語閱讀和寫作能力", TwentyFiveMinUnitPrice = 780m, FiftyMinUnitPrice = 1365m, Description = "法語閱讀和寫作的深入研究", IsEnabled = true, ThumbnailUrl = "https://example.com/courses/advanced_french.jpg", VideoUrl = "https://example.com/courses/advanced_french_intro.mp4", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 24, CategoryId = 1, SubjectId = 6, TutorId = 24, Title = "高級西班牙語", SubTitle = "提升西班牙語寫作和語法", TwentyFiveMinUnitPrice = 900m, FiftyMinUnitPrice = 1620m, Description = "西班牙語寫作和語法的深入練習", IsEnabled = true, ThumbnailUrl = "https://example.com/courses/advanced_spanish.jpg", VideoUrl = "https://example.com/courses/advanced_spanish_intro.mp4", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 25, CategoryId = 2, SubjectId = 7, TutorId = 25, Title = "高級HTML/CSS", SubTitle = "深入學習HTML和CSS技術", TwentyFiveMinUnitPrice = 500m, FiftyMinUnitPrice = 925m, Description = "高級網頁設計和開發技術", IsEnabled = true, ThumbnailUrl = "https://example.com/courses/advanced_html_css.jpg", VideoUrl = "https://example.com/courses/advanced_html_css_intro.mp4", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 26, CategoryId = 2, SubjectId = 8, TutorId = 26, Title = "高級JavaScript", SubTitle = "深入掌握JavaScript編程", TwentyFiveMinUnitPrice = 850m, FiftyMinUnitPrice = 1530m, Description = "JavaScript編程的高級應用和技巧", IsEnabled = true, ThumbnailUrl = "https://example.com/courses/advanced_javascript.jpg", VideoUrl = "https://example.com/courses/advanced_javascript_intro.mp4", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 27, CategoryId = 2, SubjectId = 9, TutorId = 27, Title = "C# 高級應用", SubTitle = "學習C#的高級應用技術", TwentyFiveMinUnitPrice = 700m, FiftyMinUnitPrice = 1225m, Description = "深入掌握C#編程的高級技術", IsEnabled = true, ThumbnailUrl = "https://example.com/courses/advanced_csharp.jpg", VideoUrl = "https://example.com/courses/advanced_csharp_intro.mp4", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 28, CategoryId = 2, SubjectId = 10, TutorId = 28, Title = "SQL 高級資料庫操作", SubTitle = "深入學習SQL資料庫管理", TwentyFiveMinUnitPrice = 600m, FiftyMinUnitPrice = 1080m, Description = "SQL資料庫管理和優化的高級技術", IsEnabled = true, ThumbnailUrl = "https://example.com/courses/advanced_sql.jpg", VideoUrl = "https://example.com/courses/advanced_sql_intro.mp4", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 29, CategoryId = 2, SubjectId = 11, TutorId = 29, Title = "Python 高級應用", SubTitle = "深入學習Python的高級應用", TwentyFiveMinUnitPrice = 900m, FiftyMinUnitPrice = 1620m, Description = "Python編程的高級應用和數據處理", IsEnabled = true, ThumbnailUrl = "https://example.com/courses/advanced_python.jpg", VideoUrl = "https://example.com/courses/advanced_python_intro.mp4", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 30, CategoryId = 2, SubjectId = 12, TutorId = 30, Title = "Java 高級應用", SubTitle = "深入學習Java的高級應用技術", TwentyFiveMinUnitPrice = 750m, FiftyMinUnitPrice = 1350m, Description = "Java編程的高級技術和應用", IsEnabled = true, ThumbnailUrl = "https://example.com/courses/advanced_java.jpg", VideoUrl = "https://example.com/courses/advanced_java_intro.mp4", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 31, CategoryId = 3, SubjectId = 13, TutorId = 31, Title = "高等數學", SubTitle = "深入學習數學的高級概念", TwentyFiveMinUnitPrice = 500m, FiftyMinUnitPrice = 890m, Description = "高等數學理論和應用", IsEnabled = true, ThumbnailUrl = "https://example.com/courses/advanced_math.jpg", VideoUrl = "https://example.com/courses/advanced_math_intro.mp4", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 32, CategoryId = 3, SubjectId = 14, TutorId = 32, Title = "高等物理", SubTitle = "深入理解物理學的高級理論", TwentyFiveMinUnitPrice = 750m, FiftyMinUnitPrice = 1350m, Description = "物理學的高級理論和應用", IsEnabled = true, ThumbnailUrl = "https://example.com/courses/advanced_physics.jpg", VideoUrl = "https://example.com/courses/advanced_physics_intro.mp4", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 33, CategoryId = 3, SubjectId = 15, TutorId = 33, Title = "高等化學", SubTitle = "深入理解化學的高級理論", TwentyFiveMinUnitPrice = 500m, FiftyMinUnitPrice = 900m, Description = "化學的高級理論和應用", IsEnabled = true, ThumbnailUrl = "https://example.com/courses/advanced_chemistry.jpg", VideoUrl = "https://example.com/courses/advanced_chemistry_intro.mp4", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 34, CategoryId = 3, SubjectId = 16, TutorId = 34, Title = "高等歷史研究", SubTitle = "深入分析歷史事件和背景", TwentyFiveMinUnitPrice = 600m, FiftyMinUnitPrice = 1050m, Description = "歷史研究的高級技術和方法", IsEnabled = true, ThumbnailUrl = "https://example.com/courses/advanced_history.jpg", VideoUrl = "https://example.com/courses/advanced_history_intro.mp4", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 35, CategoryId = 3, SubjectId = 17, TutorId = 35, Title = "高等地理學", SubTitle = "深入理解地理學的高級概念", TwentyFiveMinUnitPrice = 600m, FiftyMinUnitPrice = 1080m, Description = "地理學的高級理論和應用", IsEnabled = true, ThumbnailUrl = "https://example.com/courses/advanced_geography.jpg", VideoUrl = "https://example.com/courses/advanced_geography_intro.mp4", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 36, CategoryId = 3, SubjectId = 18, TutorId = 36, Title = "高等生物學", SubTitle = "深入理解生物學的高級理論", TwentyFiveMinUnitPrice = 900m, FiftyMinUnitPrice = 1620m, Description = "生物學的高級理論和應用", IsEnabled = true, ThumbnailUrl = "https://example.com/courses/advanced_biology.jpg", VideoUrl = "https://example.com/courses/advanced_biology_intro.mp4", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 37, CategoryId = 1, SubjectId = 1, TutorId = 37, Title = "專業英文寫作", SubTitle = "掌握專業英文寫作技巧", TwentyFiveMinUnitPrice = 550m, FiftyMinUnitPrice = 935m, Description = "專業英文寫作的高級技巧", IsEnabled = true, ThumbnailUrl = "https://example.com/courses/professional_english.jpg", VideoUrl = "https://example.com/courses/professional_english_intro.mp4", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 38, CategoryId = 1, SubjectId = 2, TutorId = 38, Title = "專業日語寫作", SubTitle = "掌握專業日語寫作技巧", TwentyFiveMinUnitPrice = 400m, FiftyMinUnitPrice = 720m, Description = "專業日語寫作的高級技巧", IsEnabled = true, ThumbnailUrl = "https://example.com/courses/professional_japanese.jpg", VideoUrl = "https://example.com/courses/professional_japanese_intro.mp4", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 39, CategoryId = 1, SubjectId = 3, TutorId = 39, Title = "專業中文寫作", SubTitle = "掌握專業中文寫作技巧", TwentyFiveMinUnitPrice = 700m, FiftyMinUnitPrice = 1260m, Description = "專業中文寫作的高級技巧", IsEnabled = true, ThumbnailUrl = "https://example.com/courses/professional_chinese.jpg", VideoUrl = "https://example.com/courses/professional_chinese_intro.mp4", CoursesStatus = 1, Cdate = DateTime.Now },
new Course { CourseId = 40, CategoryId = 1, SubjectId = 4, TutorId = 40, Title = "專業德語寫作", SubTitle = "掌握專業德語寫作技巧", TwentyFiveMinUnitPrice = 650m, FiftyMinUnitPrice = 1170m, Description = "專業德語寫作的高級技巧", IsEnabled = true, ThumbnailUrl = "https://example.com/courses/professional_german.jpg", VideoUrl = "https://example.com/courses/professional_german_intro.mp4", CoursesStatus = 1, Cdate = DateTime.Now });
...
// TutorId 4
new TutorTimeSlot { TutorTimeSlotId = 61, TutorId = 4, Weekday = 1, CourseHourId = 8, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 62, TutorId = 4, Weekday = 1, CourseHourId = 9, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 63, TutorId = 4, Weekday = 1, CourseHourId = 10, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 64, TutorId = 4, Weekday = 1, CourseHourId = 11, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 65, TutorId = 4, Weekday = 1, CourseHourId = 12, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 66, TutorId = 4, Weekday = 1, CourseHourId = 13, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 67, TutorId = 4, Weekday = 2, CourseHourId = 8, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 68, TutorId = 4, Weekday = 2, CourseHourId = 9, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 69, TutorId = 4, Weekday = 2, CourseHourId = 10, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 70, TutorId = 4, Weekday = 2, CourseHourId = 11, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 71, TutorId = 4, Weekday = 2, CourseHourId = 12, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 72, TutorId = 4, Weekday = 2, CourseHourId = 13, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 73, TutorId = 4, Weekday = 3, CourseHourId = 8, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 74, TutorId = 4, Weekday = 3, CourseHourId = 9, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 75, TutorId = 4, Weekday = 3, CourseHourId = 10, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 76, TutorId = 4, Weekday = 3, CourseHourId = 11, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 77, TutorId = 4, Weekday = 3, CourseHourId = 12, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 78, TutorId = 4, Weekday = 3, CourseHourId = 13, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 79, TutorId = 4, Weekday = 4, CourseHourId = 8, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 80, TutorId = 4, Weekday = 4, CourseHourId = 9, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 81, TutorId = 4, Weekday = 4, CourseHourId = 10, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 82, TutorId = 4, Weekday = 4, CourseHourId = 11, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 83, TutorId = 4, Weekday = 4, CourseHourId = 12, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 84, TutorId = 4, Weekday = 4, CourseHourId = 13, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 85, TutorId = 4, Weekday = 5, CourseHourId = 8, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 86, TutorId = 4, Weekday = 5, CourseHourId = 9, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 87, TutorId = 4, Weekday = 5, CourseHourId = 10, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 88, TutorId = 4, Weekday = 5, CourseHourId = 11, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 89, TutorId = 4, Weekday = 5, CourseHourId = 12, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 90, TutorId = 4, Weekday = 5, CourseHourId = 13, Cdate = DateTime.Now, Udate = DateTime.Now },
// TutorId 5
new TutorTimeSlot { TutorTimeSlotId = 91, TutorId = 5, Weekday = 1, CourseHourId = 8, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 92, TutorId = 5, Weekday = 1, CourseHourId = 9, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 93, TutorId = 5, Weekday = 1, CourseHourId = 10, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 94, TutorId = 5, Weekday = 1, CourseHourId = 11, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 95, TutorId = 5, Weekday = 2, CourseHourId = 12, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 96, TutorId = 5, Weekday = 2, CourseHourId = 13, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 97, TutorId = 5, Weekday = 2, CourseHourId = 14, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 98, TutorId = 5, Weekday = 3, CourseHourId = 8, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 99, TutorId = 5, Weekday = 3, CourseHourId = 9, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 100, TutorId = 5, Weekday = 3, CourseHourId = 10, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 101, TutorId = 5, Weekday = 3, CourseHourId = 11, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 102, TutorId = 5, Weekday = 3, CourseHourId = 12, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 103, TutorId = 5, Weekday = 4, CourseHourId = 8, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 104, TutorId = 5, Weekday = 4, CourseHourId = 9, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 105, TutorId = 5, Weekday = 4, CourseHourId = 10, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 106, TutorId = 5, Weekday = 4, CourseHourId = 11, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 107, TutorId = 5, Weekday = 4, CourseHourId = 12, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 108, TutorId = 5, Weekday = 5, CourseHourId = 8, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 109, TutorId = 5, Weekday = 5, CourseHourId = 9, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 110, TutorId = 5, Weekday = 5, CourseHourId = 10, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 111, TutorId = 5, Weekday = 5, CourseHourId = 11, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 112, TutorId = 5, Weekday = 6, CourseHourId = 12, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 113, TutorId = 5, Weekday = 6, CourseHourId = 13, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 114, TutorId = 5, Weekday = 6, CourseHourId = 14, Cdate = DateTime.Now, Udate = DateTime.Now },
// TutorId 6 (共 26 筆)
new TutorTimeSlot { TutorTimeSlotId = 115, TutorId = 6, Weekday = 1, CourseHourId = 10, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 116, TutorId = 6, Weekday = 1, CourseHourId = 11, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 117, TutorId = 6, Weekday = 1, CourseHourId = 12, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 118, TutorId = 6, Weekday = 1, CourseHourId = 13, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 119, TutorId = 6, Weekday = 2, CourseHourId = 15, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 120, TutorId = 6, Weekday = 2, CourseHourId = 16, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 121, TutorId = 6, Weekday = 2, CourseHourId = 17, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 122, TutorId = 6, Weekday = 3, CourseHourId = 10, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 123, TutorId = 6, Weekday = 3, CourseHourId = 11, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 124, TutorId = 6, Weekday = 3, CourseHourId = 12, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 125, TutorId = 6, Weekday = 3, CourseHourId = 13, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 126, TutorId = 6, Weekday = 4, CourseHourId = 9, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 127, TutorId = 6, Weekday = 4, CourseHourId = 10, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 128, TutorId = 6, Weekday = 4, CourseHourId = 11, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 129, TutorId = 6, Weekday = 5, CourseHourId = 14, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 130, TutorId = 6, Weekday = 5, CourseHourId = 15, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 131, TutorId = 6, Weekday = 5, CourseHourId = 16, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 132, TutorId = 6, Weekday = 6, CourseHourId = 18, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 133, TutorId = 6, Weekday = 6, CourseHourId = 19, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 134, TutorId = 6, Weekday = 6, CourseHourId = 20, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 135, TutorId = 6, Weekday = 6, CourseHourId = 21, Cdate = DateTime.Now, Udate = DateTime.Now },
// TutorId 7 (共 22 筆)
new TutorTimeSlot { TutorTimeSlotId = 136, TutorId = 7, Weekday = 0, CourseHourId = 9, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 137, TutorId = 7, Weekday = 0, CourseHourId = 10, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 138, TutorId = 7, Weekday = 1, CourseHourId = 11, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 139, TutorId = 7, Weekday = 1, CourseHourId = 12, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 140, TutorId = 7, Weekday = 1, CourseHourId = 13, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 141, TutorId = 7, Weekday = 2, CourseHourId = 14, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 142, TutorId = 7, Weekday = 2, CourseHourId = 15, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 143, TutorId = 7, Weekday = 2, CourseHourId = 16, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 144, TutorId = 7, Weekday = 3, CourseHourId = 18, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 145, TutorId = 7, Weekday = 3, CourseHourId = 19, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 146, TutorId = 7, Weekday = 3, CourseHourId = 20, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 147, TutorId = 7, Weekday = 3, CourseHourId = 21, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 148, TutorId = 7, Weekday = 4, CourseHourId = 8, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 149, TutorId = 7, Weekday = 4, CourseHourId = 9, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 150, TutorId = 7, Weekday = 4, CourseHourId = 10, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 151, TutorId = 7, Weekday = 5, CourseHourId = 12, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 152, TutorId = 7, Weekday = 5, CourseHourId = 13, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 153, TutorId = 7, Weekday = 5, CourseHourId = 14, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 154, TutorId = 7, Weekday = 6, CourseHourId = 16, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 155, TutorId = 7, Weekday = 6, CourseHourId = 17, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 156, TutorId = 7, Weekday = 6, CourseHourId = 18, Cdate = DateTime.Now, Udate = DateTime.Now },
// TutorId 8 (共 30 筆)
new TutorTimeSlot { TutorTimeSlotId = 157, TutorId = 8, Weekday = 0, CourseHourId = 9, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 158, TutorId = 8, Weekday = 0, CourseHourId = 10, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 159, TutorId = 8, Weekday = 0, CourseHourId = 11, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 160, TutorId = 8, Weekday = 0, CourseHourId = 12, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 161, TutorId = 8, Weekday = 1, CourseHourId = 14, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 162, TutorId = 8, Weekday = 1, CourseHourId = 15, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 163, TutorId = 8, Weekday = 1, CourseHourId = 16, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 164, TutorId = 8, Weekday = 1, CourseHourId = 17, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 165, TutorId = 8, Weekday = 2, CourseHourId = 18, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 166, TutorId = 8, Weekday = 2, CourseHourId = 19, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 167, TutorId = 8, Weekday = 2, CourseHourId = 20, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 168, TutorId = 8, Weekday = 2, CourseHourId = 21, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 169, TutorId = 8, Weekday = 3, CourseHourId = 8, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 170, TutorId = 8, Weekday = 3, CourseHourId = 9, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 171, TutorId = 8, Weekday = 3, CourseHourId = 10, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 172, TutorId = 8, Weekday = 3, CourseHourId = 11, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 173, TutorId = 8, Weekday = 4, CourseHourId = 13, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 174, TutorId = 8, Weekday = 4, CourseHourId = 14, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 175, TutorId = 8, Weekday = 4, CourseHourId = 15, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 176, TutorId = 8, Weekday = 5, CourseHourId = 17, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 177, TutorId = 8, Weekday = 5, CourseHourId = 18, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 178, TutorId = 8, Weekday = 5, CourseHourId = 19, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 179, TutorId = 8, Weekday = 6, CourseHourId = 20, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 180, TutorId = 8, Weekday = 6, CourseHourId = 21, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 181, TutorId = 8, Weekday = 6, CourseHourId = 22, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 182, TutorId = 8, Weekday = 6, CourseHourId = 23, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 183, TutorId = 8, Weekday = 0, CourseHourId = 12, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 184, TutorId = 8, Weekday = 0, CourseHourId = 13, Cdate = DateTime.Now, Udate = DateTime.Now },
new TutorTimeSlot { TutorTimeSlotId = 185, TutorId = 8, Weekday = 0, CourseHourId = 14, Cdate = DateTime.Now, Udate = DateTime.Now }
 );
