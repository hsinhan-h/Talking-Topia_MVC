...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    new Member { MemberId = 11, HeadShotImage = "https://randomuser.me/api/portraits/men/11.jpg", NationId = 1, IsVerifiedTutor = true, FirstName = "Carlos", LastName = "Miller", Password = "password11", Email = "carlos.miller@example.com", Nickname = "CarlosM", Phone = "101010101", Birthday = DateTime.Now.AddYears(-29), Gender = 1, NativeLanguage = "English", SpokenLanguage = "English, Spanish", BankCode = "011", BankAccount = "3456781234", EducationId = 11, TutorIntro = "Experienced tutor in English and Spanish", Account = "carlos_miller", AccountType = 1, CDate = DateTime.Now, UDate = DateTime.Now, IsTutor = true },
    new Member { MemberId = 12, HeadShotImage = "https://randomuser.me/api/portraits/women/12.jpg", NationId = 2, IsVerifiedTutor = false, FirstName = "Olivia", LastName = "Brown", Password = "password12", Email = "olivia.brown@example.com", Nickname = "OliviaB", Phone = "202020202", Birthday = DateTime.Now.AddYears(-24), Gender = 2, NativeLanguage = "Japanese", SpokenLanguage = "Japanese, English", BankCode = "012", BankAccount = "4567892345", EducationId = 12, TutorIntro = "Expert in Japanese language", Account = "olivia_brown", AccountType = 2, CDate = DateTime.Now, UDate = DateTime.Now, IsTutor = true },
    new Member { MemberId = 13, HeadShotImage = "https://randomuser.me/api/portraits/men/13.jpg", NationId = 3, IsVerifiedTutor = true, FirstName = "James", LastName = "Johnson", Password = "password13", Email = "james.johnson@example.com", Nickname = "JamesJ", Phone = "303030303", Birthday = DateTime.Now.AddYears(-35), Gender = 1, NativeLanguage = "Korean", SpokenLanguage = "Korean, English", BankCode = "013", BankAccount = "5678913456", EducationId = 13, TutorIntro = "Korean language specialist", Account = "james_johnson", AccountType = 1, CDate = DateTime.Now, UDate = DateTime.Now, IsTutor = true },
    new Member { MemberId = 14, HeadShotImage = "https://randomuser.me/api/portraits/women/14.jpg", NationId = 4, IsVerifiedTutor = false, FirstName = "Emma", LastName = "Garcia", Password = "password14", Email = "emma.garcia@example.com", Nickname = "EmmaG", Phone = "404040404", Birthday = DateTime.Now.AddYears(-22), Gender = 2, NativeLanguage = "German", SpokenLanguage = "German, English", BankCode = "014", BankAccount = "6789124567", EducationId = 14, TutorIntro = "Expert in German language", Account = "emma_garcia", AccountType = 2, CDate = DateTime.Now, UDate = DateTime.Now, IsTutor = true },
    new Member { MemberId = 15, HeadShotImage = "https://randomuser.me/api/portraits/men/15.jpg", NationId = 5, IsVerifiedTutor = true, FirstName = "Robert", LastName = "Martinez", Password = "password15", Email = "robert.martinez@example.com", Nickname = "RobertM", Phone = "505050505", Birthday = DateTime.Now.AddYears(-26), Gender = 1, NativeLanguage = "French", SpokenLanguage = "French, English", BankCode = "015", BankAccount = "7891235678", EducationId = 15, TutorIntro = "French language specialist", Account = "robert_martinez", AccountType = 1, CDate = DateTime.Now, UDate = DateTime.Now, IsTutor = true },
    new Member { MemberId = 16, HeadShotImage = "https://randomuser.me/api/portraits/women/16.jpg", NationId = 6, IsVerifiedTutor = false, FirstName = "Sophia", LastName = "Rodriguez", Password = "password16", Email = "sophia.rodriguez@example.com", Nickname = "SophiaR", Phone = "606060606", Birthday = DateTime.Now.AddYears(-21), Gender = 2, NativeLanguage = "Spanish", SpokenLanguage = "Spanish, English", BankCode = "016", BankAccount = "8902346789", EducationId = 16, TutorIntro = "Spanish language expert", Account = "sophia_rodriguez", AccountType = 2, CDate = DateTime.Now, UDate = DateTime.Now, IsTutor = true },
    new Member { MemberId = 17, HeadShotImage = "https://randomuser.me/api/portraits/men/17.jpg", NationId = 7, IsVerifiedTutor = true, FirstName = "Liam", LastName = "Hernandez", Password = "password17", Email = "liam.hernandez@example.com", Nickname = "LiamH", Phone = "707070707", Birthday = DateTime.Now.AddYears(-33), Gender = 1, NativeLanguage = "Chinese", SpokenLanguage = "Chinese, English", BankCode = "017", BankAccount = "9013457890", EducationId = 17, TutorIntro = "Chinese language expert", Account = "liam_hernandez", AccountType = 1, CDate = DateTime.Now, UDate = DateTime.Now, IsTutor = true },
    new Member { MemberId = 18, HeadShotImage = "https://randomuser.me/api/portraits/women/18.jpg", NationId = 8, IsVerifiedTutor = false, FirstName = "Isabella", LastName = "Lopez", Password = "password18", Email = "isabella.lopez@example.com", Nickname = "IsabellaL", Phone = "808080808", Birthday = DateTime.Now.AddYears(-20), Gender = 2, NativeLanguage = "Russian", SpokenLanguage = "Russian, English", BankCode = "018", BankAccount = "0123456789", EducationId = 18, TutorIntro = "Russian language expert", Account = "isabella_lopez", AccountType = 2, CDate = DateTime.Now, UDate = DateTime.Now, IsTutor = true },
    new Member { MemberId = 19, HeadShotImage = "https://randomuser.me/api/portraits/men/19.jpg", NationId = 9, IsVerifiedTutor = true, FirstName = "Benjamin", LastName = "Gonzalez", Password = "password19", Email = "benjamin.gonzalez@example.com", Nickname = "BenG", Phone = "909090909", Birthday = DateTime.Now.AddYears(-28), Gender = 1, NativeLanguage = "Italian", SpokenLanguage = "Italian, English", BankCode = "019", BankAccount = "1234567890", EducationId = 19, TutorIntro = "Italian language expert", Account = "benjamin_gonzalez", AccountType = 1, CDate = DateTime.Now, UDate = DateTime.Now, IsTutor = true },
    new Member { MemberId = 20, HeadShotImage = "https://randomuser.me/api/portraits/women/20.jpg", NationId = 10, IsVerifiedTutor = false, FirstName = "Mia", LastName = "Wilson", Password = "password20", Email = "mia.wilson@example.com", Nickname = "MiaW", Phone = "1010101010", Birthday = DateTime.Now.AddYears(-27), Gender = 2, NativeLanguage = "Portuguese", SpokenLanguage = "Portuguese, English", BankCode = "020", BankAccount = "2345678901", EducationId = 20, TutorIntro = "Portuguese language expert", Account = "mia_wilson", AccountType = 2, CDate = DateTime.Now, UDate = DateTime.Now, IsTutor = true },
    new Member { MemberId = 21, HeadShotImage = "https://randomuser.me/api/portraits/men/21.jpg", NationId = 1, IsVerifiedTutor = true, FirstName = "Daniel", LastName = "Anderson", Password = "password21", Email = "daniel.anderson@example.com", Nickname = "DanA", Phone = "111111111", Birthday = DateTime.Now.AddYears(-29), Gender = 1, NativeLanguage = "English", SpokenLanguage = "English, Spanish", BankCode = "021", BankAccount = "3456781234", EducationId = 21, TutorIntro = "Experienced tutor in English and Spanish", Account = "daniel_anderson", AccountType = 1, CDate = DateTime.Now, UDate = DateTime.Now, IsTutor = true },
    new Member { MemberId = 22, HeadShotImage = "https://randomuser.me/api/portraits/women/22.jpg", NationId = 2, IsVerifiedTutor = false, FirstName = "Ava", LastName = "Thomas", Password = "password22", Email = "ava.thomas@example.com", Nickname = "AvaT", Phone = "222222222", Birthday = DateTime.Now.AddYears(-24), Gender = 2, NativeLanguage = "Japanese", SpokenLanguage = "Japanese, English", BankCode = "022", BankAccount = "4567892345", EducationId = 22, TutorIntro = "Expert in Japanese language", Account = "ava_thomas", AccountType = 2, CDate = DateTime.Now, UDate = DateTime.Now, IsTutor = true },
    new Member { MemberId = 23, HeadShotImage = "https://randomuser.me/api/portraits/men/23.jpg", NationId = 3, IsVerifiedTutor = true, FirstName = "Matthew", LastName = "Jackson", Password = "password23", Email = "matthew.jackson@example.com", Nickname = "MattJ", Phone = "333333333", Birthday = DateTime.Now.AddYears(-35), Gender = 1, NativeLanguage = "Korean", SpokenLanguage = "Korean, English", BankCode = "023", BankAccount = "5678913456", EducationId = 23, TutorIntro = "Korean language specialist", Account = "matthew_jackson", AccountType = 1, CDate = DateTime.Now, UDate = DateTime.Now, IsTutor = true },
    new Member { MemberId = 24, HeadShotImage = "https://randomuser.me/api/portraits/women/24.jpg", NationId = 4, IsVerifiedTutor = false, FirstName = "Ella", LastName = "Harris", Password = "password24", Email = "ella.harris@example.com", Nickname = "EllaH", Phone = "444444444", Birthday = DateTime.Now.AddYears(-22), Gender = 2, NativeLanguage = "German", SpokenLanguage = "German, English", BankCode = "024", BankAccount = "6789124567", EducationId = 24, TutorIntro = "Expert in German language", Account = "ella_harris", AccountType = 2, CDate = DateTime.Now, UDate = DateTime.Now, IsTutor = true },
    new Member { MemberId = 25, HeadShotImage = "https://randomuser.me/api/portraits/men/25.jpg", NationId = 5, IsVerifiedTutor = true, FirstName = "Lucas", LastName = "Clark", Password = "password25", Email = "lucas.clark@example.com", Nickname = "LukeC", Phone = "555555555", Birthday = DateTime.Now.AddYears(-26), Gender = 1, NativeLanguage = "French", SpokenLanguage = "French, English", BankCode = "025", BankAccount = "7891235678", EducationId = 25, TutorIntro = "French language specialist", Account = "lucas_clark", AccountType = 1, CDate = DateTime.Now, UDate = DateTime.Now, IsTutor = true },
    new Member { MemberId = 26, HeadShotImage = "https://randomuser.me/api/portraits/women/26.jpg", NationId = 6, IsVerifiedTutor = false, FirstName = "Mia", LastName = "Lewis", Password = "password26", Email = "mia.lewis@example.com", Nickname = "MiaL", Phone = "666666666", Birthday = DateTime.Now.AddYears(-21), Gender = 2, NativeLanguage = "Spanish", SpokenLanguage = "Spanish, English", BankCode = "026", BankAccount = "8902346789", EducationId = 26, TutorIntro = "Spanish language expert", Account = "mia_lewis", AccountType = 2, CDate = DateTime.Now, UDate = DateTime.Now, IsTutor = true },
    new Member { MemberId = 27, HeadShotImage = "https://randomuser.me/api/portraits/men/27.jpg", NationId = 7, IsVerifiedTutor = true, FirstName = "Logan", LastName = "Young", Password = "password27", Email = "logan.young@example.com", Nickname = "LoganY", Phone = "777777777", Birthday = DateTime.Now.AddYears(-33), Gender = 1, NativeLanguage = "Chinese", SpokenLanguage = "Chinese, English", BankCode = "027", BankAccount = "9013457890", EducationId = 27, TutorIntro = "Chinese language expert", Account = "logan_young", AccountType = 1, CDate = DateTime.Now, UDate = DateTime.Now, IsTutor = true },
    new Member { MemberId = 28, HeadShotImage = "https://randomuser.me/api/portraits/women/28.jpg", NationId = 8, IsVerifiedTutor = false, FirstName = "Aria", LastName = "King", Password = "password28", Email = "aria.king@example.com", Nickname = "AriaK", Phone = "888888888", Birthday = DateTime.Now.AddYears(-20), Gender = 2, NativeLanguage = "Russian", SpokenLanguage = "Russian, English", BankCode = "028", BankAccount = "0123456789", EducationId = 28, TutorIntro = "Russian language expert", Account = "aria_king", AccountType = 2, CDate = DateTime.Now, UDate = DateTime.Now, IsTutor = true },
    new Member { MemberId = 29, HeadShotImage = "https://randomuser.me/api/portraits/men/29.jpg", NationId = 9, IsVerifiedTutor = true, FirstName = "Ethan", LastName = "Wright", Password = "password29", Email = "ethan.wright@example.com", Nickname = "EthanW", Phone = "999999999", Birthday = DateTime.Now.AddYears(-28), Gender = 1, NativeLanguage = "Italian", SpokenLanguage = "Italian, English", BankCode = "029", BankAccount = "1234567890", EducationId = 29, TutorIntro = "Italian language expert", Account = "ethan_wright", AccountType = 1, CDate = DateTime.Now, UDate = DateTime.Now, IsTutor = true },
    new Member { MemberId = 30, HeadShotImage = "https://randomuser.me/api/portraits/women/30.jpg", NationId = 10, IsVerifiedTutor = false, FirstName = "Charlotte", LastName = "Hill", Password = "password30", Email = "charlotte.hill@example.com", Nickname = "CharlotteH", Phone = "1010101010", Birthday = DateTime.Now.AddYears(-27), Gender = 2, NativeLanguage = "Portuguese", SpokenLanguage = "Portuguese, English", BankCode = "030", BankAccount = "2345678901", EducationId = 30, TutorIntro = "Portuguese language expert", Account = "charlotte_hill", AccountType = 2, CDate = DateTime.Now, UDate = DateTime.Now, IsTutor = true },
    new Member { MemberId = 31, HeadShotImage = "https://randomuser.me/api/portraits/men/31.jpg", NationId = 1, IsVerifiedTutor = true, FirstName = "Jack", LastName = "Scott", Password = "password31", Email = "jack.scott@example.com", Nickname = "JackS", Phone = "1111111111", Birthday = DateTime.Now.AddYears(-29), Gender = 1, NativeLanguage = "English", SpokenLanguage = "English, Spanish", BankCode = "031", BankAccount = "3456781234", EducationId = 31, TutorIntro = "Experienced tutor in English and Spanish", Account = "jack_scott", AccountType = 1, CDate = DateTime.Now, UDate = DateTime.Now, IsTutor = true },
    new Member { MemberId = 32, HeadShotImage = "https://randomuser.me/api/portraits/women/32.jpg", NationId = 2, IsVerifiedTutor = false, FirstName = "Harper", LastName = "Green", Password = "password32", Email = "harper.green@example.com", Nickname = "HarperG", Phone = "2222222222", Birthday = DateTime.Now.AddYears(-24), Gender = 2, NativeLanguage = "Japanese", SpokenLanguage = "Japanese, English", BankCode = "032", BankAccount = "4567892345", EducationId = 32, TutorIntro = "Expert in Japanese language", Account = "harper_green", AccountType = 2, CDate = DateTime.Now, UDate = DateTime.Now, IsTutor = true },
    new Member { MemberId = 33, HeadShotImage = "https://randomuser.me/api/portraits/men/33.jpg", NationId = 3, IsVerifiedTutor = true, FirstName = "Henry", LastName = "Adams", Password = "password33", Email = "henry.adams@example.com", Nickname = "HenryA", Phone = "3333333333", Birthday = DateTime.Now.AddYears(-35), Gender = 1, NativeLanguage = "Korean", SpokenLanguage = "Korean, English", BankCode = "033", BankAccount = "5678913456", EducationId = 33, TutorIntro = "Korean language specialist", Account = "henry_adams", AccountType = 1, CDate = DateTime.Now, UDate = DateTime.Now, IsTutor = true },
    new Member { MemberId = 34, HeadShotImage = "https://randomuser.me/api/portraits/women/34.jpg", NationId = 4, IsVerifiedTutor = false, FirstName = "Scarlett", LastName = "Baker", Password = "password34", Email = "scarlett.baker@example.com", Nickname = "ScarlettB", Phone = "4444444444", Birthday = DateTime.Now.AddYears(-22), Gender = 2, NativeLanguage = "German", SpokenLanguage = "German, English", BankCode = "034", BankAccount = "6789124567", EducationId = 34, TutorIntro = "Expert in German language", Account = "scarlett_baker", AccountType = 2, CDate = DateTime.Now, UDate = DateTime.Now, IsTutor = true },
    new Member { MemberId = 35, HeadShotImage = "https://randomuser.me/api/portraits/men/35.jpg", NationId = 5, IsVerifiedTutor = true, FirstName = "Levi", LastName = "Nelson", Password = "password35", Email = "levi.nelson@example.com", Nickname = "LeviN", Phone = "5555555555", Birthday = DateTime.Now.AddYears(-26), Gender = 1, NativeLanguage = "French", SpokenLanguage = "French, English", BankCode = "035", BankAccount = "7891235678", EducationId = 35, TutorIntro = "French language specialist", Account = "levi_nelson", AccountType = 1, CDate = DateTime.Now, UDate = DateTime.Now, IsTutor = true },
    new Member { MemberId = 36, HeadShotImage = "https://randomuser.me/api/portraits/women/36.jpg", NationId = 6, IsVerifiedTutor = false, FirstName = "Amelia", LastName = "Carter", Password = "password36", Email = "amelia.carter@example.com", Nickname = "AmeliaC", Phone = "6666666666", Birthday = DateTime.Now.AddYears(-21), Gender = 2, NativeLanguage = "Spanish", SpokenLanguage = "Spanish, English", BankCode = "036", BankAccount = "8902346789", EducationId = 36, TutorIntro = "Spanish language expert", Account = "amelia_carter", AccountType = 2, CDate = DateTime.Now, UDate = DateTime.Now, IsTutor = true },
    new Member { MemberId = 37, HeadShotImage = "https://randomuser.me/api/portraits/men/37.jpg", NationId = 7, IsVerifiedTutor = true, FirstName = "Mason", LastName = "Mitchell", Password = "password37", Email = "mason.mitchell@example.com", Nickname = "MasonM", Phone = "7777777777", Birthday = DateTime.Now.AddYears(-33), Gender = 1, NativeLanguage = "Chinese", SpokenLanguage = "Chinese, English", BankCode = "037", BankAccount = "9013457890", EducationId = 37, TutorIntro = "Chinese language expert", Account = "mason_mitchell", AccountType = 1, CDate = DateTime.Now, UDate = DateTime.Now, IsTutor = true },
    new Member { MemberId = 38, HeadShotImage = "https://randomuser.me/api/portraits/women/38.jpg", NationId = 8, IsVerifiedTutor = false, FirstName = "Avery", LastName = "Perez", Password = "password38", Email = "avery.perez@example.com", Nickname = "AveryP", Phone = "8888888888", Birthday = DateTime.Now.AddYears(-20), Gender = 2, NativeLanguage = "Russian", SpokenLanguage = "Russian, English", BankCode = "038", BankAccount = "0123456789", EducationId = 38, TutorIntro = "Russian language expert", Account = "avery_perez", AccountType = 2, CDate = DateTime.Now, UDate = DateTime.Now, IsTutor = true },
    new Member { MemberId = 39, HeadShotImage = "https://randomuser.me/api/portraits/men/39.jpg", NationId = 9, IsVerifiedTutor = true, FirstName = "Elijah", LastName = "Roberts", Password = "password39", Email = "elijah.roberts@example.com", Nickname = "ElijahR", Phone = "9999999999", Birthday = DateTime.Now.AddYears(-28), Gender = 1, NativeLanguage = "Italian", SpokenLanguage = "Italian, English", BankCode = "039", BankAccount = "1234567890", EducationId = 39, TutorIntro = "Italian language expert", Account = "elijah_roberts", AccountType = 1, CDate = DateTime.Now, UDate = DateTime.Now, IsTutor = true },
    new Member { MemberId = 40, HeadShotImage = "https://randomuser.me/api/portraits/women/40.jpg", NationId = 10, IsVerifiedTutor = false, FirstName = "Zoe", LastName = "Turner", Password = "password40", Email = "zoe.turner@example.com", Nickname = "ZoeT", Phone = "10101010101", Birthday = DateTime.Now.AddYears(-27), Gender = 2, NativeLanguage = "Portuguese", SpokenLanguage = "Portuguese, English", BankCode = "040", BankAccount = "2345678901", EducationId = 40, TutorIntro = "Portuguese language expert", Account = "zoe_turner", AccountType = 2, CDate = DateTime.Now, UDate = DateTime.Now, IsTutor = true }
);
...
new Booking { BookingId = 31, CourseId = 31, BookingDate = DateTime.Now, BookingTime = 1500, StudentId = 31, Cdate = DateTime.Now.AddDays(-5), Udate = DateTime.Now },
new Booking { BookingId = 32, CourseId = 32, BookingDate = DateTime.Now.AddDays(1), BookingTime = 1600, StudentId = 32, Cdate = DateTime.Now.AddDays(-4), Udate = DateTime.Now },
new Booking { BookingId = 33, CourseId = 33, BookingDate = DateTime.Now.AddDays(2), BookingTime = 1000, StudentId = 33, Cdate = DateTime.Now.AddDays(-3), Udate = DateTime.Now },
new Booking { BookingId = 34, CourseId = 34, BookingDate = DateTime.Now.AddDays(3), BookingTime = 1100, StudentId = 34, Cdate = DateTime.Now.AddDays(-2), Udate = DateTime.Now },
new Booking { BookingId = 35, CourseId = 35, BookingDate = DateTime.Now.AddDays(4), BookingTime = 1400, StudentId = 35, Cdate = DateTime.Now.AddDays(-1), Udate = DateTime.Now },
new Booking { BookingId = 36, CourseId = 36, BookingDate = DateTime.Now.AddDays(5), BookingTime = 1500, StudentId = 36, Cdate = DateTime.Now, Udate = DateTime.Now },
new Booking { BookingId = 37, CourseId = 37, BookingDate = DateTime.Now.AddDays(6), BookingTime = 1600, StudentId = 37, Cdate = DateTime.Now.AddDays(1), Udate = DateTime.Now },
new Booking { BookingId = 38, CourseId = 38, BookingDate = DateTime.Now.AddDays(7), BookingTime = 1000, StudentId = 38, Cdate = DateTime.Now.AddDays(2), Udate = DateTime.Now },
new Booking { BookingId = 39, CourseId = 39, BookingDate = DateTime.Now.AddDays(8), BookingTime = 900, StudentId = 39, Cdate = DateTime.Now.AddDays(3), Udate = DateTime.Now },
new Booking { BookingId = 40, CourseId = 40, BookingDate = DateTime.Now.AddDays(9), BookingTime = 1100, StudentId = 40, Cdate = DateTime.Now.AddDays(4), Udate = DateTime.Now }
    ...
    new Review { ReviewId = 31, StudentId = 31, CourseId = 31, Rating = 5, CommentText = "Very engaging.", CDate = DateTime.Now, UDate = DateTime.Now },
    new Review { ReviewId = 32, StudentId = 32, CourseId = 32, Rating = 4, CommentText = "Well structured.", CDate = DateTime.Now.AddDays(1), UDate = DateTime.Now },
    new Review { ReviewId = 33, StudentId = 33, CourseId = 33, Rating = 5, CommentText = "Very insightful.", CDate = DateTime.Now.AddDays(2), UDate = DateTime.Now },
    new Review { ReviewId = 34, StudentId = 34, CourseId = 34, Rating = 4, CommentText = "Good examples.", CDate = DateTime.Now.AddDays(3), UDate = DateTime.Now },
    new Review { ReviewId = 35, StudentId = 35, CourseId = 35, Rating = 5, CommentText = "Highly detailed.", CDate = DateTime.Now.AddDays(4), UDate = DateTime.Now },
    new Review { ReviewId = 36, StudentId = 36, CourseId = 36, Rating = 4, CommentText = "Great value.", CDate = DateTime.Now.AddDays(5), UDate = DateTime.Now },
    new Review { ReviewId = 37, StudentId = 37, CourseId = 37, Rating = 5, CommentText = "Highly recommend.", CDate = DateTime.Now.AddDays(6), UDate = DateTime.Now },
    new Review { ReviewId = 38, StudentId = 38, CourseId = 38, Rating = 4, CommentText = "Very useful.", CDate = DateTime.Now.AddDays(7), UDate = DateTime.Now },
    new Review { ReviewId = 39, StudentId = 39, CourseId = 39, Rating = 5, CommentText = "Excellent insights.", CDate = DateTime.Now.AddDays(8), UDate = DateTime.Now },
    new Review { ReviewId = 40, StudentId = 40, CourseId = 40, Rating = 4, CommentText = "Clear explanations.", CDate = DateTime.Now.AddDays(9), UDate = DateTime.Now }
);
    ...
    new ShoppingCartBooking { BookingId = 1, CourseId = 1, BookingDate = DateTime.Now.AddDays(-20).Date, BookingTime = 10, MemberId = 1, TempShoppingCartId = 1, CDate = DateTime.Now.AddDays(-20), UDate = DateTime.Now.AddDays(-19) },
    new ShoppingCartBooking { BookingId = 2, CourseId = 2, BookingDate = DateTime.Now.AddDays(-19).Date, BookingTime = 11, MemberId = 2, TempShoppingCartId = 2, CDate = DateTime.Now.AddDays(-19), UDate = DateTime.Now.AddDays(-18) },
    new ShoppingCartBooking { BookingId = 3, CourseId = 3, BookingDate = DateTime.Now.AddDays(-18).Date, BookingTime = 12, MemberId = 3, TempShoppingCartId = 3, CDate = DateTime.Now.AddDays(-18), UDate = DateTime.Now.AddDays(-17) },
    new ShoppingCartBooking { BookingId = 4, CourseId = 4, BookingDate = DateTime.Now.AddDays(-17).Date, BookingTime = 13, MemberId = 4, TempShoppingCartId = 4, CDate = DateTime.Now.AddDays(-17), UDate = DateTime.Now.AddDays(-16) },
    new ShoppingCartBooking { BookingId = 5, CourseId = 5, BookingDate = DateTime.Now.AddDays(-16).Date, BookingTime = 14, MemberId = 5, TempShoppingCartId = 5, CDate = DateTime.Now.AddDays(-16), UDate = DateTime.Now.AddDays(-15) },
    new ShoppingCartBooking { BookingId = 6, CourseId = 6, BookingDate = DateTime.Now.AddDays(-15).Date, BookingTime = 15, MemberId = 6, TempShoppingCartId = 6, CDate = DateTime.Now.AddDays(-15), UDate = DateTime.Now.AddDays(-14) },
    new ShoppingCartBooking { BookingId = 7, CourseId = 7, BookingDate = DateTime.Now.AddDays(-14).Date, BookingTime = 16, MemberId = 7, TempShoppingCartId = 7, CDate = DateTime.Now.AddDays(-14), UDate = DateTime.Now.AddDays(-13) },
    new ShoppingCartBooking { BookingId = 8, CourseId = 8, BookingDate = DateTime.Now.AddDays(-13).Date, BookingTime = 17, MemberId = 8, TempShoppingCartId = 8, CDate = DateTime.Now.AddDays(-13), UDate = DateTime.Now.AddDays(-12) },
    new ShoppingCartBooking { BookingId = 9, CourseId = 9, BookingDate = DateTime.Now.AddDays(-12).Date, BookingTime = 18, MemberId = 9, TempShoppingCartId = 9, CDate = DateTime.Now.AddDays(-12), UDate = DateTime.Now.AddDays(-11) },
    new ShoppingCartBooking { BookingId = 10, CourseId = 10, BookingDate = DateTime.Now.AddDays(-11).Date, BookingTime = 19, MemberId = 10, TempShoppingCartId = 10, CDate = DateTime.Now.AddDays(-11), UDate = DateTime.Now.AddDays(-10) },
    new ShoppingCartBooking { BookingId = 11, CourseId = 11, BookingDate = DateTime.Now.AddDays(-10).Date, BookingTime = 20, MemberId = 11, TempShoppingCartId = 11, CDate = DateTime.Now.AddDays(-10), UDate = DateTime.Now.AddDays(-9) },
    new ShoppingCartBooking { BookingId = 12, CourseId = 12, BookingDate = DateTime.Now.AddDays(-9).Date, BookingTime = 21, MemberId = 12, TempShoppingCartId = 12, CDate = DateTime.Now.AddDays(-9), UDate = DateTime.Now.AddDays(-8) },
    new ShoppingCartBooking { BookingId = 13, CourseId = 13, BookingDate = DateTime.Now.AddDays(-8).Date, BookingTime = 22, MemberId = 13, TempShoppingCartId = 13, CDate = DateTime.Now.AddDays(-8), UDate = DateTime.Now.AddDays(-7) },
    new ShoppingCartBooking { BookingId = 14, CourseId = 14, BookingDate = DateTime.Now.AddDays(-7).Date, BookingTime = 23, MemberId = 14, TempShoppingCartId = 14, CDate = DateTime.Now.AddDays(-7), UDate = DateTime.Now.AddDays(-6) },
    new ShoppingCartBooking { BookingId = 15, CourseId = 15, BookingDate = DateTime.Now.AddDays(-6).Date, BookingTime = 24, MemberId = 15, TempShoppingCartId = 15, CDate = DateTime.Now.AddDays(-6), UDate = DateTime.Now.AddDays(-5) },
    new ShoppingCartBooking { BookingId = 16, CourseId = 16, BookingDate = DateTime.Now.AddDays(-5).Date, BookingTime = 25, MemberId = 16, TempShoppingCartId = 16, CDate = DateTime.Now.AddDays(-5), UDate = DateTime.Now.AddDays(-4) },
    new ShoppingCartBooking { BookingId = 17, CourseId = 17, BookingDate = DateTime.Now.AddDays(-4).Date, BookingTime = 26, MemberId = 17, TempShoppingCartId = 17, CDate = DateTime.Now.AddDays(-4), UDate = DateTime.Now.AddDays(-3) },
    new ShoppingCartBooking { BookingId = 18, CourseId = 18, BookingDate = DateTime.Now.AddDays(-3).Date, BookingTime = 27, MemberId = 18, TempShoppingCartId = 18, CDate = DateTime.Now.AddDays(-3), UDate = DateTime.Now.AddDays(-2) },
    new ShoppingCartBooking { BookingId = 19, CourseId = 19, BookingDate = DateTime.Now.AddDays(-2).Date, BookingTime = 28, MemberId = 19, TempShoppingCartId = 19, CDate = DateTime.Now.AddDays(-2), UDate = DateTime.Now.AddDays(-1) },
    new ShoppingCartBooking { BookingId = 20, CourseId = 20, BookingDate = DateTime.Now.AddDays(-1).Date, BookingTime = 29, MemberId = 20, TempShoppingCartId = 20, CDate = DateTime.Now.AddDays(-1), UDate = DateTime.Now }
);
        modelBuilder.Entity<TutorTimeSlot>().HasData(
     new TutorTimeSlot { TutorTimeSlotId = 1, CourseId = 1, AvailableDate = DateTime.Now.AddDays(1).Date, StartTime = DateTime.Now.AddHours(8).TimeOfDay, EndTime = DateTime.Now.AddHours(9).TimeOfDay, TutorId = 1, CDate = DateTime.Now, UDate = DateTime.Now.AddDays(1) },
     new TutorTimeSlot { TutorTimeSlotId = 2, CourseId = 2, AvailableDate = DateTime.Now.AddDays(2).Date, StartTime = DateTime.Now.AddHours(9).TimeOfDay, EndTime = DateTime.Now.AddHours(10).TimeOfDay, TutorId = 2, CDate = DateTime.Now, UDate = DateTime.Now.AddDays(2) },
     new TutorTimeSlot { TutorTimeSlotId = 3, CourseId = 3, AvailableDate = DateTime.Now.AddDays(3).Date, StartTime = DateTime.Now.AddHours(10).TimeOfDay, EndTime = DateTime.Now.AddHours(11).TimeOfDay, TutorId = 3, CDate = DateTime.Now, UDate = DateTime.Now.AddDays(3) },
     new TutorTimeSlot { TutorTimeSlotId = 4, CourseId = 4, AvailableDate = DateTime.Now.AddDays(4).Date, StartTime = DateTime.Now.AddHours(11).TimeOfDay, EndTime = DateTime.Now.AddHours(12).TimeOfDay, TutorId = 4, CDate = DateTime.Now, UDate = DateTime.Now.AddDays(4) },
     new TutorTimeSlot { TutorTimeSlotId = 5, CourseId = 5, AvailableDate = DateTime.Now.AddDays(5).Date, StartTime = DateTime.Now.AddHours(12).TimeOfDay, EndTime = DateTime.Now.AddHours(13).TimeOfDay, TutorId = 5, CDate = DateTime.Now, UDate = DateTime.Now.AddDays(5) },
     new TutorTimeSlot { TutorTimeSlotId = 6, CourseId = 6, AvailableDate = DateTime.Now.AddDays(6).Date, StartTime = DateTime.Now.AddHours(13).TimeOfDay, EndTime = DateTime.Now.AddHours(14).TimeOfDay, TutorId = 6, CDate = DateTime.Now, UDate = DateTime.Now.AddDays(6) },
     new TutorTimeSlot { TutorTimeSlotId = 7, CourseId = 7, AvailableDate = DateTime.Now.AddDays(7).Date, StartTime = DateTime.Now.AddHours(14).TimeOfDay, EndTime = DateTime.Now.AddHours(15).TimeOfDay, TutorId = 7, CDate = DateTime.Now, UDate = DateTime.Now.AddDays(7) },
     new TutorTimeSlot { TutorTimeSlotId = 8, CourseId = 8, AvailableDate = DateTime.Now.AddDays(8).Date, StartTime = DateTime.Now.AddHours(15).TimeOfDay, EndTime = DateTime.Now.AddHours(16).TimeOfDay, TutorId = 8, CDate = DateTime.Now, UDate = DateTime.Now.AddDays(8) },
     new TutorTimeSlot { TutorTimeSlotId = 9, CourseId = 9, AvailableDate = DateTime.Now.AddDays(9).Date, StartTime = DateTime.Now.AddHours(16).TimeOfDay, EndTime = DateTime.Now.AddHours(17).TimeOfDay, TutorId = 9, CDate = DateTime.Now, UDate = DateTime.Now.AddDays(9) },
     new TutorTimeSlot { TutorTimeSlotId = 10, CourseId = 10, AvailableDate = DateTime.Now.AddDays(10).Date, StartTime = DateTime.Now.AddHours(17).TimeOfDay, EndTime = DateTime.Now.AddHours(18).TimeOfDay, TutorId = 10, CDate = DateTime.Now, UDate = DateTime.Now.AddDays(10) },
     new TutorTimeSlot { TutorTimeSlotId = 11, CourseId = 11, AvailableDate = DateTime.Now.AddDays(11).Date, StartTime = DateTime.Now.AddHours(18).TimeOfDay, EndTime = DateTime.Now.AddHours(19).TimeOfDay, TutorId = 11, CDate = DateTime.Now, UDate = DateTime.Now.AddDays(11) },
     new TutorTimeSlot { TutorTimeSlotId = 12, CourseId = 12, AvailableDate = DateTime.Now.AddDays(12).Date, StartTime = DateTime.Now.AddHours(19).TimeOfDay, EndTime = DateTime.Now.AddHours(20).TimeOfDay, TutorId = 12, CDate = DateTime.Now, UDate = DateTime.Now.AddDays(12) },
     new TutorTimeSlot { TutorTimeSlotId = 13, CourseId = 13, AvailableDate = DateTime.Now.AddDays(13).Date, StartTime = DateTime.Now.AddHours(20).TimeOfDay, EndTime = DateTime.Now.AddHours(21).TimeOfDay, TutorId = 13, CDate = DateTime.Now, UDate = DateTime.Now.AddDays(13) },
     new TutorTimeSlot { TutorTimeSlotId = 14, CourseId = 14, AvailableDate = DateTime.Now.AddDays(14).Date, StartTime = DateTime.Now.AddHours(21).TimeOfDay, EndTime = DateTime.Now.AddHours(22).TimeOfDay, TutorId = 14, CDate = DateTime.Now, UDate = DateTime.Now.AddDays(14) },
     new TutorTimeSlot { TutorTimeSlotId = 15, CourseId = 15, AvailableDate = DateTime.Now.AddDays(15).Date, StartTime = DateTime.Now.AddHours(22).TimeOfDay, EndTime = DateTime.Now.AddHours(23).TimeOfDay, TutorId = 15, CDate = DateTime.Now, UDate = DateTime.Now.AddDays(15) },
     new TutorTimeSlot { TutorTimeSlotId = 16, CourseId = 16, AvailableDate = DateTime.Now.AddDays(16).Date, StartTime = DateTime.Now.AddHours(8).TimeOfDay, EndTime = DateTime.Now.AddHours(9).TimeOfDay, TutorId = 16, CDate = DateTime.Now, UDate = DateTime.Now.AddDays(16) },
     new TutorTimeSlot { TutorTimeSlotId = 17, CourseId = 17, AvailableDate = DateTime.Now.AddDays(17).Date, StartTime = DateTime.Now.AddHours(9).TimeOfDay, EndTime = DateTime.Now.AddHours(10).TimeOfDay, TutorId = 17, CDate = DateTime.Now, UDate = DateTime.Now.AddDays(17) },
     new TutorTimeSlot { TutorTimeSlotId = 18, CourseId = 18, AvailableDate = DateTime.Now.AddDays(18).Date, StartTime = DateTime.Now.AddHours(10).TimeOfDay, EndTime = DateTime.Now.AddHours(11).TimeOfDay, TutorId = 18, CDate = DateTime.Now, UDate = DateTime.Now.AddDays(18) },
     new TutorTimeSlot { TutorTimeSlotId = 19, CourseId = 19, AvailableDate = DateTime.Now.AddDays(19).Date, StartTime = DateTime.Now.AddHours(11).TimeOfDay, EndTime = DateTime.Now.AddHours(12).TimeOfDay, TutorId = 19, CDate = DateTime.Now, UDate = DateTime.Now.AddDays(19) },
     new TutorTimeSlot { TutorTimeSlotId = 20, CourseId = 20, AvailableDate = DateTime.Now.AddDays(20).Date, StartTime = DateTime.Now.AddHours(12).TimeOfDay, EndTime = DateTime.Now.AddHours(13).TimeOfDay, TutorId = 20, CDate = DateTime.Now, UDate = DateTime.Now.AddDays(20) }
 );
