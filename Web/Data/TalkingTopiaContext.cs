...
new Member { MemberId = 40, HeadShotImage = "https://randomuser.me/api/portraits/women/40.jpg", NationId = 10, IsVerifiedTutor = false, FirstName = "Ella", LastName = "Wood", Password = "password40", Email = "ella.wood@example.com", Nickname = "EllaW", Phone = "222333444", Birthday = DateTime.Now.AddYears(-28), Gender = 2, NativeLanguage = "Portuguese", SpokenLanguage = "Portuguese, English", BankCode = "040", BankAccount = "2345678901", EducationId = 10, TutorIntro = "Portuguese language expert", Account = "ella_wood", AccountType = 2, Cdate = DateTime.Now, Udate = DateTime.Now, IsTutor = true }
);
