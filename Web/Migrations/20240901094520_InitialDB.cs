    ...
    public partial class InitialDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5838), "SUMMER2024", "夏季優惠", 10, 1, new DateTime(2024, 10, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5827), true, null },
                    { 2, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5842), "WELCOME2024", "新用戶優惠", 20, 1, new DateTime(2024, 12, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5840), true, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6137), "00:00", null },
                    { 2, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6139), "01:00", null },
                    { 3, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6163), "02:00", null },
                    { 4, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6165), "03:00", null },
                    { 5, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6166), "04:00", null },
                    { 6, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6168), "05:00", null },
                    { 7, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6170), "06:00", null },
                    { 8, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6171), "07:00", null },
                    { 9, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6173), "08:00", null },
                    { 10, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6174), "09:00", null },
                    { 11, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6176), "10:00", null },
                    { 12, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6177), "11:00", null },
                    { 13, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6179), "12:00", null },
                    { 14, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6180), "13:00", null },
                    { 15, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6182), "14:00", null },
                    { 16, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6183), "15:00", null },
                    { 17, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6185), "16:00", null },
                    { 18, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6186), "17:00", null },
                    { 19, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6188), "18:00", null },
                    { 20, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6189), "19:00", null },
                    { 21, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6191), "20:00", null },
                    { 22, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6192), "21:00", null },
                    { 23, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6194), "22:00", null },
                    { 24, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6195), "23:00", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5285), "資訊工程", "台灣大學", 2014, 2010, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5303) },
                    { 2, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5312), "數學系", "東京大學", 2016, 2012, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5312) },
                    { 3, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5315), "經濟系", "哈佛大學", 2019, 2015, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5315) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "語言學習", new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5518), 1, null },
                    { 2, "程式設計", new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5520), 2, null },
                    { 3, "升學科目", new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5523), 2, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5636), 1, "https://picsum.photos/id/100/450/300", null },
                    { 2, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5638), 1, "https://picsum.photos/id/101/450/300", null },
                    { 3, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5681), 1, "https://picsum.photos/id/102/450/300", null },
                    { 4, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5683), 2, "https://picsum.photos/id/103/450/300", null },
                    { 5, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5685), 2, "https://picsum.photos/id/104/450/300", null },
                    { 6, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5687), 2, "https://picsum.photos/id/105/450/300", null },
                    { 7, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5689), 3, "https://picsum.photos/id/106/450/300", null },
                    { 8, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5691), 3, "https://picsum.photos/id/107/450/300", null },
                    { 9, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5693), 3, "https://picsum.photos/id/108/450/300", null },
                    { 10, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5695), 4, "https://picsum.photos/id/109/450/300", null },
                    { 11, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5697), 4, "https://picsum.photos/id/110/450/300", null },
                    { 12, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5700), 4, "https://picsum.photos/id/111/450/300", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "xiaoming_account", 1, "12345678", "123", new DateTime(1990, 5, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5360), 1, "xiaoming@example.com", "小明", (short)1, "xiaoming.jpg", true, true, "王", 1, "中文", "明哥", "hashedpassword1", "0912345678", "英文", "專業C#講師", new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5363) },
                    { 2, "ken_account", 2, "87654321", "456", new DateTime(1985, 8, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5407), 2, "ken@example.com", "健", (short)1, "ken.jpg", false, false, "佐藤", 2, "日語", "健哥", "hashedpassword2", "0800123456", "中文", "日語教學專家", new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5408) },
                    { 3, "john_doe_account", 1, "98765432", "789", new DateTime(1992, 11, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5417), 3, "john@example.com", "John", (short)1, "john_doe.jpg", true, true, "Doe", 3, "英文", "Johnny", "hashedpassword3", "0700123456", "西班牙語", "資深英語導師", new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5417) },
                    { 4, "akimo_account", 1, "98765432", "700", new DateTime(1990, 7, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5424), 3, "akimo@example.com", "Akimo", (short)0, "~/image/tutor_headshot_imgs/tutor_demo_jp_001.webp", true, true, "Sato", 2, "日文", "Akimo", "hashedpassword4", "0711111111", "日文", "こんにちは！👋 私は Akimoです。生まれも育ちも日本で、日本語を教えることに情熱を持っています。🇯🇵 私は大学で日本語教育を専攻し、修士課程を修了後、さまざまな学校や語学機関で7年間教鞭を執ってきました。📚 これまでに、世界中の多くの学生たちに日本語の魅力を伝え、彼らが日本語能力試験に合格し、仕事や日常生活で日本語を自由に使えるようにサポートしてきました。🎓\r\n\r\n私は、生徒一人ひとりの個性を大切にし、それぞれの目標に応じた最適な学習プランを提供します。🎯 私の授業では、単なる文法や単語の暗記だけでなく、実際に使える日本語を身につけることに重点を置いています。具体的な場面を想定した会話練習や、文化についてのディスカッションを通じて、言葉の背景にある日本の文化や価値観も理解していただけるよう努めています。🎌\r\n\r\n私の目標は、皆さんが日本語を学ぶ楽しさを実感し、自信を持って日本語を使えるようになることです。💪 一緒に日本語の世界を探求し、新しい可能性を広げていきましょう！🚀 お会いできるのを楽しみにしています。😊", new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5424) },
                    { 5, "david_account", 1, "98765432", "789", new DateTime(1993, 11, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5431), 3, "todd@example.com", "大衛", (short)1, "~/image/tutor_headshot_imgs/tutor_head_002.png", true, false, "李", 1, "英文", "David", "hashedpassword5", "0700222454", "英文 中文", "嗨！我是 👩‍🏫 李老師，擁有 10 年的教學經驗！📚\r\n\r\n🎓 我持有 英文教師證 的證書，並且擁有多次國際英語教學的實戰經驗。對於不同年齡層的學生，我都有教學的方法與技巧，尤其擅長讓學習變得有趣且富有成效。🌈\r\n\r\n在這堂課中，我會根據學生的需求和程度量身定製教學計畫，讓每一位學生都能在輕鬆的氛圍中學習。課程的設計旨在建立自信心，讓你能夠在日常生活中自如地使用英語，無論是與朋友交談、旅遊還是商務會議中，都能夠流利溝通。🚀", new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5432) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5901), true, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5902), 1, "無", new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5904) },
                    { 2, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5906), false, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5907), 2, "不符合資格", new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5908) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 9, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), (short)15, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5936), 1, 2, null },
                    { 2, new DateTime(2024, 9, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), (short)16, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5939), 2, 2, null },
                    { 3, new DateTime(2024, 9, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), (short)16, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5942), 2, 4, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5556), 1, "英文", null },
                    { 2, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5559), 1, "日文", null },
                    { 3, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5561), 1, "中文", null },
                    { 4, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5563), 1, "德文", null },
                    { 5, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5565), 1, "法文", null },
                    { 6, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5567), 1, "西班牙文", null },
                    { 7, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5569), 2, "HTML/CSS", null },
                    { 8, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5572), 2, "JavaScript", null },
                    { 9, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5574), 2, "C#", null },
                    { 10, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5575), 2, "SQL", null },
                    { 11, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5577), 2, "Python", null },
                    { 12, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5579), 2, "Java", null },
                    { 13, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5582), 3, "數學", null },
                    { 14, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5584), 3, "物理", null },
                    { 15, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5586), 3, "化學", null },
                    { 16, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5588), 3, "歷史", null },
                    { 17, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5590), 3, "地理", null },
                    { 18, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5592), 3, "生物", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5752), null, (short)1, 1, (short)1, "Credit Card", null, null, 1000m, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5749), null, null },
                    { 2, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5757), null, (short)1, 2, (short)1, "Paypal", null, null, 2000m, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5755), null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5967), 1, "C# 認證", "csharp_certificate.jpg", null },
                    { 2, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5969), 2, "日語能力測驗 N1", "jlpt_n1.jpg", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5997), "很棒的課程！", 1, (byte)5, 1, null },
                    { 2, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6000), "非常實用！", 2, (byte)4, 2, null },
                    { 3, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6002), "講得不錯! 但笑話有點冷", 1, (byte)4, 2, null },
                    { 4, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6004), "讚讚讚", 1, (byte)4, 3, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, null, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6029), 1, (short)1, 1, (short)2, 1000m, null, 500m },
                    { 2, null, null, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6032), 2, (short)1, 2, (short)1, 1000m, null, 1000m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6111), 1, null, new DateTime(2023, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6109), "csharp_experience.pdf", null, new DateTime(2021, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6108) },
                    { 2, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6114), 2, null, new DateTime(2022, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6113), "japanese_experience.pdf", null, new DateTime(2019, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6112) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5874), 1, 1, null },
                    { 2, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(5876), 2, 2, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, (short)800, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6059), 1, 1, 1, null },
                    { 2, null, (short)900, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6061), 2, 2, 2, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6085), 12, 1, null, 1 },
                    { 2, 2, new DateTime(2024, 9, 1, 17, 45, 19, 894, DateTimeKind.Local).AddTicks(6087), 13, 1, null, 1 }
                });
